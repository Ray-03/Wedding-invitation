    ...
    >
      ...
      <div className="max-w-3xl mx-auto w-full relative z-10 flex flex-col items-center text-center space-y-10">
        ...
        <div className="space-y-6">
          ...
          <div className="w-16 h-[1px] bg-[#3A75C4]/50 mx-auto" />
          
          <p className="font-sans text-base sm:text-lg text-[#03307B]/70 max-w-xl mx-auto leading-relaxed italic">
